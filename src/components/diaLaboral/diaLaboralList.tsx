...
const DIAS_SEMANA: Record<number, { nombre: string; color: string; emoji: string }> = {
  0: { nombre: "Domingo",   color: "bg-purple-500", emoji: "🟣" },
  1: { nombre: "Lunes",     color: "bg-blue-500",   emoji: "🔵" },
  2: { nombre: "Martes",    color: "bg-green-500",  emoji: "🟢" },
  3: { nombre: "Miércoles", color: "bg-yellow-500", emoji: "🟡" },
  4: { nombre: "Jueves",    color: "bg-orange-500", emoji: "🟠" },
  5: { nombre: "Viernes",   color: "bg-red-500",    emoji: "🔴" },
  6: { nombre: "Sábado",    color: "bg-pink-500",   emoji: "🟣" },
}
