...
type PropiedadesFilaBarbero = { barbero: BarberoListado; servicios: ServicioOpcion[]; diasLaborales: DiaLaboral[]; menuAbierto: boolean; onAlternarMenu: () => void };
...
export default function BarberoFila({ barbero, servicios, diasLaborales, menuAbierto, onAlternarMenu }: PropiedadesFilaBarbero) {
