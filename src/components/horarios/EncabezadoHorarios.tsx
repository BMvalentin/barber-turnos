    ...
    <div className="flex items-start justify-between gap-4">
      ...
      {hayEmpleados && (
        ...
        >
          ...
          {esEmpleado ? "Configurar horario" : "Nuevo horario"}
        </Button>
      )}
    </div>
  );
